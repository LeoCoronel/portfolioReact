        ...
        <Section id="contact">
            <Div>
                ...
                <div className="social-btns ">
                    <a href="https://www.linkedin.com/in/leonardo-m-coronel/" className="btn linkedin" target="_blank"><img src={"../src/img/linkedin.svg"} alt="linkedin"/></a>
                    ...
                    <a href="mailto:'leomcoronel99@gmail.com'" className="btn email" target="_blank"><img src={"../src/img/gmail.svg"} alt="gmail" /></a>
                </div>
            </Div>
        </Section>
        )
