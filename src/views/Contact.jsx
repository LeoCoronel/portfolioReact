...
const Div = Styled.div`
    ...
    .social-btns {
        ...
        .btn {
            ...
            border-radius: 28%;
            padding: 1em;
            border: 1px solid ${(props) => props.theme.mainColorSticky};
